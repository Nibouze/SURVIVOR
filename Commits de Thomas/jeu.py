...
dictionnaire_images = {
    ...
    14: charger_et_redimensionner_image(f'{chemin}/{corners[1]}/top_left_interior_corner.png'),
    15: charger_et_redimensionner_image(f'{chemin}/{corners[1]}/top_right_interior_corner.png'),
